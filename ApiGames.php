...
class ApiGames
{
    ...
    {
        $postdata = [
            'voucherPricePoint.id'              => 223412,
            'voucherPricePoint.price'           => 81000.0,
            'voucherPricePoint.variablePrice'   => 0,
            'n'                                 => '12/7/2022-2015',
            'email'                             => '',
            'userVariablePrice'                 => 0,
...
/**
    ...
    {
        $postdata = [
            'voucherPricePoint.id'              => 855424,
            'voucherPricePoint.price'           => 79000.0,
            'voucherPricePoint.variablePrice'   => 0,
            'n'                                 => '12/7/2022-2015',
            'email'                             => '',
            'userVariablePrice'                 => 0,
...
public function HONKAI_STAR_RAIL($id, $otherid = '') {
    // Mapping wilayah ke user.zoneId
    $userZoneIdMapping = [
    ...
    // Pastikan wilayah yang diberikan ada dalam daftar mapping
    if (array_key_exists($otherid, $userZoneIdMapping)) {
        $userZoneId = $userZoneIdMapping[$otherid];
        ...
        $postdata = [
            ...
            'email'                             => '',
            'userVariablePrice'                 => 0,
            'order.data.profile'                => 'eyNuYW1lIjoiICIsImRhdGVvZmJpcnRoIjoiIiwiaWR_fb8iOiIifQ==', // Modifikasi sesuai kebutuhan
            'user.userId'                       => $id,
            'user.zoneId'                       => $userZoneId, // Gunakan nilai sesuai wilayah
            'msisdn'                            => '',
            'voucherTypeName'                   => 'HONKAI_STAR_RAIL',
            'shopLang'                          => 'id_ID',
            'voucherTypeId'                     => 327,
        ...
        // Wilayah yang diberikan tidak valid
        return json_encode(['status' => 400, 'msg' => 'Invalid region']);
    }
}
